...
template <class T>
void Set<T>::setError(string AddE, string RemE, string GetE) {
  internalStorage.setError(AddE,RemE,GetE);
}

template <class T>
string Set<T>::getAddErr() const {
  return internalStorage.getAddErr();
}

template <class T>
string Set<T>::getRemErr() const {
  return internalStorage.getRemErr();
}

template <class T>
string Set<T>::getGetErr() const {
  return internalStorage.getGetErr();
}

template <class T>
bool Set<T>::traverseFirst() const {
  return internalStorage.leaderGet();
}

template <class T>
bool Set<T>::traverseNext() const {
  return internalStorage.leaderNext();
}
